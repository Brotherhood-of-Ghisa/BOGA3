...
Three docs, kept short and current. They answer: how do I verify, what are the
tech choices, and where does code live?

- `docs/specs/02-quality-and-test-gates.md` — quality/test gates, what's
  mandatory, the infrastructure you have, and how to run each lane.
