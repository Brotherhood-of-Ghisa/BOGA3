...
# Container resolution lives in _containers.sh so it can be unit-tested without
# a slot lease (the meta-tests lane is infra-free and runs in CI).
# shellcheck disable=SC1091
source "${SCRIPT_DIR}/_containers.sh"
