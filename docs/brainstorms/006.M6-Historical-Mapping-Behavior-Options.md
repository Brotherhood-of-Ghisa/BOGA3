...
This brainstorm is intended to support `docs/plans/tasks/T-20260224-05-m6-historical-mapping-behavior-options.md` (the historical-mapping task; note the task is `-05`, not `-04`).
