...
> (`docs/plans/README.md`). Drop any section that doesn't help. The card is
> deleted when its work ships, so evidence belongs in the PR body.
...
- Milestone spec: `docs/plans/milestones/<milestone-id>.md`
