...
- Optional helper command:
  - `./scripts/task-bootstrap.sh docs/plans/tasks/M19-T02-Add_load_input_mode_schema_and_sync_contract.md`
...
- Run `./scripts/task-closeout-check.sh docs/plans/tasks/M19-T02-Add_load_input_mode_schema_and_sync_contract.md` or document why `N/A`.
