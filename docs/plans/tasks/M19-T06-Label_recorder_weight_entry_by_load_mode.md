...
- Optional helper command:
  - `./scripts/task-bootstrap.sh docs/plans/tasks/M19-T06-Label_recorder_weight_entry_by_load_mode.md`
...
- Run `./scripts/task-closeout-check.sh docs/plans/tasks/M19-T06-Label_recorder_weight_entry_by_load_mode.md` or document why `N/A`.
