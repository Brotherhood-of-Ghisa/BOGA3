...
- Optional helper command:
  - `./scripts/task-bootstrap.sh docs/plans/tasks/M19-T04-Update_per_side_muscle_analytics.md`
...
- Run `./scripts/task-closeout-check.sh docs/plans/tasks/M19-T04-Update_per_side_muscle_analytics.md` or document why `N/A`.
