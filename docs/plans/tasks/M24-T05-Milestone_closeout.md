...
docs_touched: "docs/specs/00-product.md, docs/specs/03-technical-architecture.md, docs/specs/05-data-model.md, docs/specs/06-testing-strategy.md, docs/specs/09-project-structure.md, docs/specs/ui/**, docs/plans/milestones/**, docs/specs/README.md"
---
...
9. Fill every task completion note, move completed task cards to
   `docs/plans/tasks/`, move the M24 spec to
   `docs/plans/milestones/`, and update all inbound references.
