...
- Optional helper command:
  - `./scripts/task-bootstrap.sh docs/plans/tasks/M19-T07-Update_stats_history_docs_and_ui_contracts.md`
...
- Run `./scripts/task-closeout-check.sh docs/plans/tasks/M19-T07-Update_stats_history_docs_and_ui_contracts.md` or document why `N/A`.
