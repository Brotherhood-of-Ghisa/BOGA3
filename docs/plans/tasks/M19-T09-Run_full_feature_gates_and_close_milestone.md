...
docs_touched: "docs/plans/milestones/M19-per-side-muscle-volume.md, docs/plans/tasks/M19-*.md"
---
...
- Milestone spec: `docs/plans/milestones/M19-per-side-muscle-volume.md`
...
- Parent refs opened in this session:
  ...
  - `docs/plans/milestones/M19-per-side-muscle-volume.md`
...
- Optional helper command:
  - `./scripts/task-bootstrap.sh docs/plans/tasks/M19-T09-Run_full_feature_gates_and_close_milestone.md`
...
- Update M19 task statuses and move completed/outdated cards to `docs/plans/tasks/`.
- Update `docs/plans/milestones/M19-per-side-muscle-volume.md` status and completion note when complete.
...
- Planned docs/spec files to update and why:
  - `docs/plans/milestones/M19-per-side-muscle-volume.md` - set final status and completion note if milestone closes.
  - `docs/plans/tasks/M19-*.md` - update statuses, completion notes, and move completed/outdated cards.
...
- Run `./scripts/task-closeout-check.sh docs/plans/tasks/M19-T09-Run_full_feature_gates_and_close_milestone.md` or document why `N/A`.
