...
- Optional helper command:
  - `./scripts/task-bootstrap.sh docs/plans/tasks/M19-T08-Add_backend_and_sync_contract_coverage.md`
...
- Run `./scripts/task-closeout-check.sh docs/plans/tasks/M19-T08-Add_backend_and_sync_contract_coverage.md` or document why `N/A`.
