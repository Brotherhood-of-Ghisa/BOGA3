...
- Optional helper command:
  - `./scripts/task-bootstrap.sh docs/plans/tasks/M19-T03-Add_seeded_exercise_load_mode_metadata.md`
...
- Planned docs/spec files to update and why:
  ...
  - `docs/plans/milestones/M19-per-side-muscle-volume.md` - update only if seed classification changes a locked product example or task boundary.
...
- Run `./scripts/task-closeout-check.sh docs/plans/tasks/M19-T03-Add_seeded_exercise_load_mode_metadata.md` or document why `N/A`.
