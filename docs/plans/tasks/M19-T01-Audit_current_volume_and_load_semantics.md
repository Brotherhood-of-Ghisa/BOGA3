...
gates_slow: "N/A"
docs_touched: "docs/plans/milestones/M19-per-side-muscle-volume.md"
---
...
- Optional helper command:
  - `./scripts/task-bootstrap.sh docs/plans/tasks/M19-T01-Audit_current_volume_and_load_semantics.md`
...
- Planned docs/spec files to update and why:
  - `docs/plans/milestones/M19-per-side-muscle-volume.md` - update only if the audit discovers a product or implementation constraint that changes the milestone contract.
  - `docs/plans/tasks/M19-T02-Add_load_input_mode_schema_and_sync_contract.md` through `docs/plans/tasks/M19-T09-Run_full_feature_gates_and_close_milestone.md` - update only if task boundaries need correction.
...
- Run `./scripts/task-closeout-check.sh docs/plans/tasks/M19-T01-Audit_current_volume_and_load_semantics.md` or document why `N/A`.
