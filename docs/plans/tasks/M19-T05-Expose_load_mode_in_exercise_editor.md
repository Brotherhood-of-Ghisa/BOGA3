...
- Optional helper command:
  - `./scripts/task-bootstrap.sh docs/plans/tasks/M19-T05-Expose_load_mode_in_exercise_editor.md`
...
- Run `./scripts/task-closeout-check.sh docs/plans/tasks/M19-T05-Expose_load_mode_in_exercise_editor.md` or document why `N/A`.
