---
task_id: M20-T05-Verify_frontend_catalog_and_picker_behaviour
milestone_id: "M20"
status: planned
ui_impact: "yes"
areas: "frontend|docs"
...
# M20-T05-Verify_frontend_catalog_and_picker_behaviour

## Task metadata

- Task ID: M20-T05-Verify_frontend_catalog_and_picker_behaviour
...
- Optional helper command:
  - `./scripts/task-bootstrap.sh docs/plans/tasks/M20-T05-Verify_frontend_catalog_and_picker_behaviour.md`
...
- Stale old-client update-required sync messaging; `M20-T07` owns that
