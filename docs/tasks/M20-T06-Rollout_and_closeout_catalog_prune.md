...
docs_touched: "docs/specs/milestones/M20-prune-starter-exercise-catalog.md, docs/specs/02-quality-and-test-gates.md"
---
...
- Optional helper command:
  - `./scripts/task-bootstrap.sh docs/tasks/M20-T06-Rollout_and_closeout_catalog_prune.md`
...
- Move completed M20 task cards to `docs/tasks/complete/` as appropriate.
...
- Planned docs/spec files to update and why:
  - `docs/specs/milestones/M20-prune-starter-exercise-catalog.md` - closeout status and completion note.
