...
gates_slow: "N/A"
docs_touched: "docs/specs/milestones/M24-current-session-insights-and-pr-celebration.md"
---
...
- Existing calculations: `apps/mobile/src/data/muscle-analytics.ts`,
  ...
  `apps/mobile/src/exercise-calculations.ts`
...
- `docs/specs/milestones/M24-current-session-insights-and-pr-celebration.md`:
...
- Run `./boga test fast`.
- Run `./boga test for --diff origin/main` and record the required lanes.
- Slow gate is `N/A` because this task adds pure TypeScript calculations and no
  screen/component/navigation behavior.
