...
gates_slow: "N/A"
docs_touched: "docs/specs/milestones/M20-prune-starter-exercise-catalog.md"
---
...
- Optional helper command:
  - `./scripts/task-bootstrap.sh docs/tasks/M20-T01-Prune_starter_catalog_seed_bundle.md`
...
- Planned docs/spec files to update and why:
  - `docs/specs/milestones/M20-prune-starter-exercise-catalog.md` - update task status/details if the finalized keep set changes during implementation.
