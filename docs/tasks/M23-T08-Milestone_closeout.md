...
9. **Archive.** Set task statuses/completion notes, move M23 cards to
   `docs/tasks/complete/`, move this milestone spec to
   `docs/specs/milestones/archive/`, and update every inbound index/reference in
   the same change.
