...
- `docs/specs/milestones/M22-groups-and-foundations.md`: In progress (T01–T05 shipped; T06 Maestro lane and T07 closeout remain) — groups, invites, members/roles, and the group stream of co-members' sessions (first server→other-user data flow).
...
- `docs/specs/tech/groups-contract.md`: Partially built (M22: server, client, and UI as-built; the two-user Maestro lane pending) group domain contract — share-ledger schema, share rule, group RPCs, stream metrics, mobile group client.
