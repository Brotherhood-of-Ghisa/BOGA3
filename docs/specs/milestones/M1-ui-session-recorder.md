...
6. `docs/tasks/T-20260526-01-issue-70-exercise-block-history.md` - Issue 70 phase 0A: recent per-exercise completed-session block stats in the recorder. (`in_progress`)
