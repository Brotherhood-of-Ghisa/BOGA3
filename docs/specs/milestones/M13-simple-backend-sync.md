...
7. `docs/tasks/complete/T-20260604-01-boga-import-json-contract-and-gymbook-digester.md` - post-M13 source-neutral session import JSON contract and GymBook export digester for sync-load preparation. (`completed`)
8. `docs/tasks/complete/T-20260604-02-boga-import-json-local-importer.md` - completed generic local SQLite importer for the BOGA session import JSON contract. (`completed`)
