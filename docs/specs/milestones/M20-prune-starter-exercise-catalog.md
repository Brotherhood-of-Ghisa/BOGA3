...
1. `docs/tasks/M20-T01-Prune_starter_catalog_seed_bundle.md` - Prune starter catalog seed bundle (`planned`).
2. `docs/tasks/M20-T02-Add_catalog_bundle_migration_for_existing_clients.md` - Add catalog bundle migration for existing clients (`planned`).
3. `docs/tasks/M20-T03-Add_remote_catalog_cleanup_migration.md` - Add remote catalog cleanup migration (`planned`).
4. `docs/tasks/M20-T07-Add_server_sync_push_guard_for_deprecated_seed_rows.md` - Add server sync_push guard for deprecated seed rows (`planned`).
5. `docs/tasks/M20-T04-Add_catalog_prune_regression_tests.md` - Add catalog prune regression tests (`planned`).
6. `docs/tasks/M20-T05-Verify_frontend_catalog_and_picker_behaviour.md` - Verify frontend catalog and picker behaviour (`planned`).
7. `docs/tasks/M20-T06-Rollout_and_closeout_catalog_prune.md` - Rollout and closeout catalog prune (`planned`).
