...
- Key states (high level):
  ...
  - the effort sheet (W-Up / None / RIR 3 / RIR 2 / RIR 1 / RIR 0) and the ⋮ sheet (Edit exercise / Swap exercise / Remove from session)
