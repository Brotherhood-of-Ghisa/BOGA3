...
| --- | --- | --- | --- |
| Machine-global | `~/.config/boga/` | Seeded once per machine by `scripts/boga-config-init.sh` (invoked by setup) | Hosted Supabase credentials, shared CLI version, shared Edge Function identity defaults |
