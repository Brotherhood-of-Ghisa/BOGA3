...
./boga test frontend   # boots the iOS simulator, runs Maestro smoke + data-smoke + auth-profile + sync e2e + two-user groups e2e
...
| agent-auth-web | `./boga test agent-auth-web` | `boga test fast` (repo half) | ✅ | N/A |
| mcp-unit | `./boga test mcp-unit` | `boga test fast` (repo half) | ✅ | N/A |
...
| groups-contract | `./boga test groups-contract` | `boga test backend` | ❌ | N/A |
| groups-leaderboards | `./boga test groups-leaderboards` | `boga test backend` | ❌ | ~46s |
| agent-api | `./boga test agent-api` | `boga test backend` | ❌ | N/A |
...
| mcp-smoke | `./boga test mcp-smoke` | `boga test backend` | ❌ | N/A |
| *Infra: iOS simulator + Metro — never CI-able (+ local Supabase where noted)* | | | | |
| ios-smoke | `./boga test ios-smoke` | `boga test frontend` | ❌ | ~53s |
...
| ios-groups-e2e *(+ local Supabase)* | `./boga test ios-groups-e2e` | `boga test frontend` | ❌ | N/A |
